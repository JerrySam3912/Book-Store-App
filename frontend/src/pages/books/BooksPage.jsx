...
import { HiOutlineMagnifyingGlass, HiOutlineAdjustmentsHorizontal, HiOutlineXMark, HiOutlineHeart, HiHeart } from 'react-icons/hi2'
...
const GridBookCard = ({ book, isInWishlist, onToggleWishlist, onAddToCart }) => {
    return (
